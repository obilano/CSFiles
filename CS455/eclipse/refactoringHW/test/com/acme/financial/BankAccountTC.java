...
import com.acme.financial.CheckingAccount;

class BankAccountTC {

	@Test
	void testDeposit() throws Exception {
		CheckingAccount acct = new CheckingAccount(0);
	...
	void testWithdraw() throws Exception {
		CheckingAccount acct1 = new CheckingAccount(100);
